...
public class B_InDecrease {
	...
	/*
	 * 증감연산자 (단항연산자) ++ -- ++ : 변수에 담긴 값을 1증가 ++ 변수(전위연산자) 변수++(후위연산자)
	 * 
	 * -- : 변수에 담긴 값을 1감소 (증감연산자))변수 : 전위연산-> 선증감 후처리 변수(증감연산자) : 후위연산-> 선처리 후증감
	 */
	...
	public void method4() {
		...
		System.out.printf("a: %d , b: %d, c: %d", a, b, c);// a= 12 b= 20 c= 29
